...
namespace Shikashi
{
    class MimeMapping
    {
        private Dictionary<string, string> mimeMap;
        private static readonly MimeMapping instance = new MimeMapping();

        internal static MimeMapping Instance
        {
            get
            {
                return instance;
        ...
        private MimeMapping()
        {
            ...
            mimeMap.Add(".3g2", "video/3gpp2");
            mimeMap.Add(".3gp2", "video/3gpp2");
            mimeMap.Add(".3gp", "video/3gpp");
            mimeMap.Add(".3gpp", "video/3gpp");
            mimeMap.Add(".aaf", "application/octet-stream");
            mimeMap.Add(".aac", "audio/aac");
            ...
            mimeMap.Add(".adt", "audio/vnd.dlna.adts");
            mimeMap.Add(".adts", "audio/vnd.dlna.adts");
            ...
            mimeMap.Add(".cab", "application/vnd.ms-cab-compressed");
            ...
            mimeMap.Add(".dvr-ms", "video/x-ms-dvr");
            ...
            mimeMap.Add(".eot", "application/vnd.ms-fontobject");
            ...
            mimeMap.Add(".json", "application/json");
            ...
            mimeMap.Add(".m2ts", "video/vnd.dlna.mpeg-tts");
            mimeMap.Add(".m3u", "audio/x-mpegurl");
            mimeMap.Add(".m4a", "audio/mp4");
            mimeMap.Add(".m4v", "video/mp4");
            ...
            mimeMap.Add(".oga", "audio/ogg");
            mimeMap.Add(".ogg", "video/ogg");
            mimeMap.Add(".ogv", "video/ogg");
            ...
            mimeMap.Add(".svgz", "image/svg+xml");
            ...
            mimeMap.Add(".wtv", "video/x-ms-wtv");
            ...
            mimeMap.Add(".xht", "application/xhtml+xml");
            mimeMap.Add(".xhtml", "application/xhtml+xml");
